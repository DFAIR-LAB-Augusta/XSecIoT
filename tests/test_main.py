...
#     )
#     monkeypatch.setattr(
#         main_mod, 'run_binary_classification', lambda agg_f, unsw, pca: calls.__setitem__('bin', calls['bin'] + 1)
#     )
#     monkeypatch.setattr(
#         main_mod,
...
#     )
#     monkeypatch.setattr(main_mod, 'run_feature_engineering', lambda agg_f: calls.__setitem__('fe', calls['fe'] + 1))
#     # for simulations, return a list of length 2 so main can call len()
#     monkeypatch.setattr(
#         main_mod, 'sequential_simulation', lambda **kwargs: calls.__setitem__('seq', calls['seq'] + 1) or [0, 1]
#     )
#     monkeypatch.setattr(
#         main_mod, 'continuous_simulation', lambda **kwargs: ([], calls.__setitem__('cont', calls['cont'] + 1) or [0, 1])
#     )
#     monkeypatch.setattr(
#         main_mod, 'parallel_simulation', lambda **kwargs: calls.__setitem__('par', calls['par'] + 1) or [0, 1]
#     )
...
#     monkeypatch.setattr(
#         main_mod, 'run_preprocessing', lambda *args, **kwargs: calls.__setitem__('pre', calls['pre'] + 1)
#     )
#     monkeypatch.setattr(
#         main_mod, 'run_binary_classification', lambda *args, **kwargs: calls.__setitem__('bin', calls['bin'] + 1)
#     )
#     monkeypatch.setattr(
#         main_mod, 'sequential_simulation', lambda **kwargs: calls.__setitem__('seq', calls['seq'] + 1) or []
#     )
...
#     monkeypatch.setattr(
#         main_mod, 'sequential_simulation', lambda **kwargs: calls.__setitem__('sim', calls['sim'] + 1) or []
#     )
#     monkeypatch.setattr(
#         main_mod, 'continuous_simulation', lambda **kwargs: ([], calls.__setitem__('sim', calls['sim'] + 1) or [])
#     )
#     monkeypatch.setattr(
#         main_mod, 'parallel_simulation', lambda **kwargs: calls.__setitem__('sim', calls['sim'] + 1) or []
#     )
